function [out] = GenerateTrajectoryGLM_with_Mislabeling_parallel(in)

x=in.PP;
r_range=in.r_range;
N_ens=in.N_ens;GLM_function=in.GLM;
X=in.X;


%x,X,GLM_function,r_range
...
for n_ens=1:1:N_ens
    ...
    out.LogL_range(n_ens,:)=-(1/(TT_full))*LogL_range;
end
end
